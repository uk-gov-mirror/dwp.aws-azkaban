...
resource "aws_security_group_rule" "allow_azkaban_external_webserver_ingress_azkaban_database" {
  description              = "Allows azkaban external webserver to access azkaban database"
  type                     = "ingress"
  protocol                 = "tcp"
  from_port                = aws_rds_cluster.azkaban_database.port
  to_port                  = aws_rds_cluster.azkaban_database.port
...
resource "aws_security_group_rule" "allow_azkaban_external_executor_ingress_azkaban_database" {
